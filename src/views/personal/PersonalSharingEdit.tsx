        ...
        return (
          <Grid container spacing={3}>
            ...
            {documentURI && (
              <>
                <Grid item>
                  <Typography className={classes.documentLabel}>
                    已上傳的檔案:{" "}
                  </Typography>
                  <Link
                    href={
                      UNIVERSALS.GOOGLE_STORAGE_ENDPOINT +
                      data?.pendingPost?.documentURI
                    }
                  ...
                  >
                    ...
                    <div>
                      <label style={{ fontSize: 18, overflowWrap: "anywhere" }}>
        ...
        <FormProvider {...methods}>
          <form onSubmit={handleSubmit(onSubmit)}>
            <Container>
              {!allStepsCompleted() &&
                data?.pendingPost &&
                getAlert(data?.pendingPost.status, data.pendingPost.remarks)}
