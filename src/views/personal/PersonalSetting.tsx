...
const useStyles = makeStyles((theme: Theme) => ({
  ...
  profilePicOverlay: {
    ...
    background:
      "linear-gradient(65deg, rgba(46,204,113,0.4), rgba(243,156,18,0.4))",
    color: "#fafafa",
    fontSize: 24,
    "&:hover": {
      opacity: 1,
...
export default function PersonalSetting() {
  ...
  const [changePassword, { loading: changePwdLoading }] =
    useChangePasswordMutation();
  ...
  const onSubmit = async (data: any) => {
    ...
    let tmp: UpdateUser = {
      ...
      gender: data.gender,
      profilePic: await compressImage(acceptedFiles[0], 0.05),
      ...
      setTimeout(() => {
        reset({
          ...
          dob: userData.user?.dob
            ? moment(userData.user.dob, "yyyy-MM-DDTHH:mm:ss-SSSS")
            : null,
        });
      });
    }
  ...
  return (
    <>
      {(loading || updateUserLoading || changePwdLoading) && (
        ...
        <div className={classes.root}>
          ...
          <div style={{ overflow: "auto", width: "100%" }}>
            <TabPanel value={value} index={0}>
              {loading && (
                <Grid container item spacing={3} xs={12} md={6} lg={4}>
                          ...
                          <div className={classes.profilePicContainer}>
                            {acceptedFiles.length === 0 &&
                              ...
                              !userData.user?.profilePicURI && (
                                <img alt="no avatar" src={defaultAvatar} />
                              )}
                            {acceptedFiles.length > 0 && (
                              <Avatar
                            ...
                            {userData &&
                              userData.user?.profilePicURI != null &&
                              acceptedFiles.length === 0 && (
                                <Avatar
                                  className={classes.avatar}
                                  src={
