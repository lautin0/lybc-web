          ...
          <Container>
            ...
            <Row>
              <Col md="6">
                ...
                <p>
                  <a href={require("assets/pdf/journal1.pdf")} target="_blank">第一期</a>
                </p>
                <p>
                  <a href={require("assets/pdf/journal2.pdf")} target="_blank">第二期</a>
                </p>
                <p>
                  <a href={require("assets/pdf/journal3.pdf")} target="_blank">第三期</a>
                </p>
                <p>
                  <a href={require("assets/pdf/journal4.pdf")} target="_blank">第四期</a>
                </p>
                <p>
                  <a href={require("assets/pdf/journal5.pdf")} target="_blank">第五期</a>
                </p>
                <p>
                  <a href={require("assets/pdf/journal6.pdf")} target="_blank">第六期</a>
                </p>
