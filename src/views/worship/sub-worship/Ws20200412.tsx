        ...
        >
          ...
          <Tab eventKey="script" title="經文">
            <div className="text-left mb-5">
              ...
              <h4><b className="mr-3">1 : 15 因此，我既聽見你們信從主耶穌，親愛眾聖徒，</b></h4>
              <h4><b className="mr-3">1 : 16 就為你們不住的感謝神。禱告的時候，常提到你們，</b></h4>
              <h4><b className="mr-3">1 : 17 求我們主耶穌基督的神，榮耀的父，將那賜人智慧和啟示的靈賞給你們，使你們真知道他，</b></h4>
              <h4><b className="mr-3">1 : 18 並且照明你們心中的眼睛，使你們知道他的恩召有何等指望，他在聖徒中得的基業有何等豐盛的榮耀；</b></h4>
              <h4><b className="mr-3">1 : 19 並知道他向我們這信的人所顯的能力是何等浩大，</b></h4>
              <h4><b className="mr-3">1 : 20 就是照他在基督身上所運行的大能大力，使他從死裡復活，叫他在天上坐在自己的右邊，</b></h4>
              <h4><b className="mr-3">1 : 21 遠超過一切執政的、掌權的、有能的、主治的，和一切有名的；不但是今世的，連來世的也都超過了。</b></h4>
              <h4><b className="mr-3">1 : 22 又將萬有服在他的腳下，使他為教會作萬有之首。</b></h4>
              <h4><b className="mr-3">1 : 23 教會是他的身體，是那充滿萬有者所充滿的。</b></h4>
            </div>
          </Tab>
        </Tabs>
      </Row>
