const UNIVERSALS = {
    ...
    NOTIFICATION: {
        MESSAGE: `
        <p>綠楊浸信會應對武漢肺炎疫症措施通告(2020 年 2 月 5 日更新)</p><p><br></p>
        <p>有鑑武漢肺炎疫情嚴峻，為避免交叉感染，教會安排如下🔖:</p><p><br></p>
        <p>1. 本周所有聚會及2月9日的主日崇拜，以及主日各聚會取消。建議信徒留在家中參與其他姊妹教會的網上崇拜直播😇。（之後的安排，將於下周三公布🙏🏻）</p>
        <div class="text-center w-100">
            <a class="btn btn-warning" style="font-size: 24px;" href="/worship/20200223">前往網上崇拜錄播</a>
        </div>
        <p><br></p><p>2. 在此期間，南豐辦公室及綠楊教會並不向外開放。🚪</p><p><br></p>
