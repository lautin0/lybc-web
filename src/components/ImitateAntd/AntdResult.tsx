...
const renderIcon = (prefixCls: string, { status, icon }: ResultProps) => {
   ...
   return <div className={className}><span role="img" className="anticon">{icon || iconNode}</span></div>;
};
...
AntdResult.PRESENTED_IMAGE_403 = ExceptionMap['403'];
AntdResult.PRESENTED_IMAGE_404 = ExceptionMap['404'];
AntdResult.PRESENTED_IMAGE_500 = ExceptionMap['500'];
