      ...
      <Navbar className={"fixed-top " + navbarColor} expand="lg" style={{ background: 'white' }}>
        <Container>
          <div className="navbar-translate">
            ...
            <div>
              {(['/', '/index'].includes(location.pathname) && UNIVERSALS.NOTIFICATION.MESSAGE != null) && <div className="d-inline-block d-lg-none">
                <a
                  href="#pablo"
                  onClick={(e: any) => {
                    e.preventDefault();
          ...
          >
            <Nav>
              {(['/', '/index'].includes(location.pathname) && UNIVERSALS.NOTIFICATION.MESSAGE != null) && <Nav.Item className="d-none d-lg-inline">
                <Nav.Link
                  href="#pablo"
                  onClick={(e: any) => {
                    e.preventDefault();
